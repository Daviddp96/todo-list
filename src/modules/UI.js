...
export default class UI {
  ...
  static loadHomepage() {
    UI.renderProjects()
    UI.startProjectButtons()
    UI.renderProject('Inbox', document.getElementById('button-inbox-projects'))
  ...
  static openInboxTasks() {
    UI.renderProject('Inbox', this)
  }

  static openTodayTasks() {
    Storage.updateTodayProject()
    UI.renderProject('Today', this)
  }

  static openWeekTasks() {
    Storage.updateWeekProject()
    UI.renderProject('This week', this)
  }
  ...
  static handleProjectButton(e) {
    ...
    UI.renderProject(projectName, this)
  }

  static renderProject(projectName, projectButton) {
